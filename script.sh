...
sudo mysql -uroot -e "CREATE USER 'esther'@'localhost' IDENTIFIED BY 'vagrant';"
sudo mysql -uroot -e "GRANT ALL PRIVILEGES ON Exam.* TO 'esther'@'localhost';"
cd /var/www/laravel
...
sudo sed -i '26 s/=root/=esther/' /var/www/laravel/.env
